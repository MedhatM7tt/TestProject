...
//    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position){
                case 0:
                    Subject_DoctorActivity subject_doctorActivity=new Subject_DoctorActivity();
                    return subject_doctorActivity;

                case 1:
                    SelectGraphActivity selectGraphActivity=new SelectGraphActivity();
                    return selectGraphActivity;
                default:
                    return null;
